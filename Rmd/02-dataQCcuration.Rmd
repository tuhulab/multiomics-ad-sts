...
```{r}
# heatmap_before_non_normalized <- 
#   se_qc %>% 
#   plot_heatmap_from_se(assay_no = 1)
# 
# draw(heatmap_before_non_normalized, heatmap_legend_side = "right",
#      annotation_legend_side = "top", merge_legend = FALSE)
```

## after filtering MT-genes
```{r}
se_qc[rownames(se_qc) %>% str_detect("MT-"),se_qc$qc_0_3 > 1] %>% assay() %>% colSums()
```
